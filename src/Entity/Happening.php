...
class Happening
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Tag::class, mappedBy="happenings")
     */
    private $tags;

    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="happenings")
